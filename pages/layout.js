...
export default function Layout({ children }) {
  ...
  return (
    <div className={`h-screen lg:p-[0.8rem] flex flex-col select-none font-circular`}>
      ...
      <div className='flex relative h-full justify-between gap-2 w-[90%] mx-auto '>
        {/* left most side */}
        <div
          className={`w-80 h-screen left-0 lg:rounded-xl -top-10 lg:top-0 lg:left-0 lg:h-full overflow-hidden bg-DeepNightBlack shadow-2xl z-50 lg:flex flex-col  lg:relative ${
